...
class KiliSmile_Modern_Donation_System {
    ...
    public function handle_donation_ajax() {
        try {
            ...
            $gateway = $this->gateway_factory->get_gateway($donation_data['payment_method']);
    ...
    public function get_payment_methods() {
        try {
            ...
            $methods = $this->gateway_factory->get_gateway_config($currency);
    ...
    public function check_payment_status() {
        try {
            ...
            $gateway = $this->gateway_factory->get_gateway($donation['payment_method']);
    ...
    public function handle_paypal_webhook() {
        try {
            $gateway = $this->gateway_factory->get_gateway('paypal');
    ...
    public function handle_selcom_webhook() {
        try {
            $gateway = $this->gateway_factory->get_gateway('selcom');
            if ($gateway && method_exists($gateway, 'handle_webhook')) {
                $result = $gateway->handle_webhook();
