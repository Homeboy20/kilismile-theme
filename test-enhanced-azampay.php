<?php
/**
 * Test Enhanced AzamPay Integration
 * Demonstrates both STK Push and Checkout Page functionality with the enhanced integration
 */
...
if ($_POST && wp_verify_nonce($_POST['test_nonce'], 'test_enhanced_azampay')) {
    try {
        ...
        if ($payment_method === 'checkout') {
            ...
            if ($result['success']) {
                ...
                echo '<p><strong>Provider:</strong> ' . esc_html($result['provider']) . '</p>';
...
<div class="azampay-test-container">
    <h1>🚀 Enhanced AzamPay Integration Test</h1>
    
    <div class="info-box">
        <h3>📋 Test Information</h3>
        <p><strong>Purpose:</strong> Test the enhanced AzamPay integration with both STK Push and Checkout Page</p>
    ...
    <form method="post" class="test-form">
        <?php wp_nonce_field('test_enhanced_azampay', 'test_nonce'); ?>
    ...
    <div style="margin-top: 20px; padding: 20px; background: #fcfcfc; border-radius: 8px; border: 1px solid #eee;">
        <h3>ℹ️ Enhanced Integration Features</h3>
        <ul style="list-style-type: disc; padding-left: 20px;">
            <li>Improved token management with automatic renewal</li>
            <li>Better error handling and detailed logging</li>
            <li>Support for both STK Push and Checkout methods</li>
            <li>Proper phone number formatting</li>
            <li>Comprehensive callback handling</li>
            <li>Detailed transaction status checking</li>
        </ul>
    </div>
</div>
